...
$('#muestradetalleactividadmodal').html('<center><i class="fa fa-spin fa-spinner"></i> Cargando información, por favor espere....</center>');

var dataString = 'BuscaDetalleActividadModal=si&id_rel_industria_actividad='+id_rel_industria_actividad;
...
function UpdateActividad(id_rel_industria_actividad,id_industria,nombre_de_fantasia,id_actividad,nomenclatura_ib,descripcion,es_actividad_principal,fecha_inicio,observacion,actividad_contribuyente,proceso) 
{
  ...
  $("#saveactividad #id_industria").val(id_industria);
  $("#saveactividad #nombre_de_fantasia").text(nombre_de_fantasia);
  $("#saveactividad #id_actividad").val(id_actividad);
  $("#saveactividad #search_codigo").val(nomenclatura_ib);
  $("#saveactividad #search_descripcion").val(descripcion);
  $("#saveactividad #detalle_actividad").val(nomenclatura_ib+' - '+descripcion);
  $("#saveactividad #es_actividad_principal").val(es_actividad_principal);
  $("#saveactividad #fecha_inicio").val(fecha_inicio);
  $("#saveactividad #observacion").val(observacion);
  $("#saveactividad #fecha_contribuyente").val(actividad_contribuyente);
        ...
        swal({
          ...
          confirmButtonColor: "#808080"
             ...
             $.ajax({
                  type: "GET",
                  url: "eliminar.php",
                  data: "id_rel_industria_actividad="+id_rel_industria_actividad+"&tipo="+tipo,
                  success: function(data){
...
function AddProductoActividad(id_rel_industria_actividad,descripcion,anio) 
{
  ...
  $("#saveasignacionproducto #anio_producto").val(anio);

  $('#div_productos').html('<center><i class="fa fa-spin fa-spinner"></i> Cargando información, por favor espere....</center>');

var dataString = 'BuscaProductosAsignados=si&id_rel_industria_actividad='+id_rel_industria_actividad;
  ...
  porcentaje_sobre_produccion,ventas_en_provincia,ventas_en_otras_provincias,ventas_internacionales,anio,proceso) 
{
  ...
  $("#saveasignacionproducto #id_asignacion_producto").val(id_rel_industria_actividad);
  $("#saveasignacionproducto #id_producto").val(id_producto);
  $("#saveasignacionproducto #search_producto").val(nomproducto);
  $("#saveasignacionproducto #medida_producto").val(id_unidad_de_medida);
  $("#saveasignacionproducto #cantidad_producida").val(cantidad_producida);
  $("#saveasignacionproducto #porcentaje_sobre_produccion").val(porcentaje_sobre_produccion);
  $("#saveasignacionproducto #ventas_en_provincia").val(ventas_en_provincia);
  $("#saveasignacionproducto #ventas_en_otras_provincias").val(ventas_en_otras_provincias);
  $("#saveasignacionproducto #ventas_internacionales").val(ventas_internacionales);
  $("#saveasignacionproducto #anio_producto").val(anio);
  $("#saveasignacionproducto #asignaproducto").val(proceso);
}
        ...
        swal({
          ...
          confirmButtonColor: "#808080"
             ...
             $.ajax({
                  type: "GET",
                  url: "eliminar.php",
                  data: "id_rel_actividad_productos="+id_rel_actividad_productos+"&tipo="+tipo,
                  success: function(data){
...
function AddMateriaActividad(id_rel_industria_actividad,id_rel_actividad_productos,descripcion,nomproducto,anio) 
{
  ...
  $("#saveasignacionmateria #id_asignacion_materia").val(id_rel_actividad_productos);
  $("#saveasignacionmateria #descripcion").text(descripcion);
  $("#saveasignacionmateria #nomproducto").text(nomproducto);
  $("#saveasignacionmateria #anio_materia").val(anio);

  $('#div_materiaprima').html('<center><i class="fa fa-spin fa-spinner"></i> Cargando información, por favor espere....</center>');

var dataString = 'BuscaMateriaPrimaAsignada=si&id_rel_actividad_productos='+id_rel_actividad_productos;
        ...
        swal({
          ...
          confirmButtonColor: "#808080"
             ...
             $.ajax({
                  type: "GET",
                  url: "eliminar.php",
                  data: "id_rel_actividad_productos_materia_prima="+id_rel_actividad_productos_materia_prima+"&tipo="+tipo,
                  success: function(data){
