...
$('document').ready(function() {
    $("#formlogin").validate({
        ...
        messages: {
            ...
            password: {
                required: "Ingrese Clave de Acceso"
            },
        },
...
$('document').ready(function() {
    ...
    $("#updatepassword").validate({
        ...
        messages: {
            ...
            password: {
                required: "Ingrese su Nuevo Password",
                minlength: "Ingrese 8 caracteres como minimo"
            },
            password2: {
                required: "Repita su Nuevo Password",
                minlength: "Ingrese 8 caracteres como minimo",
...
$('document').ready(function() {
    ...
    $("#configuracion").validate({
        ...
        messages: {
            cuit: {
                required: "Ingrese N&deg; de Cuit",
                digits: "Ingrese solo digitos para N&deg; de Cuit"
            },
            nomsucursal: {
                required: "Ingrese Raz&oacute;n Social"
            },
            tlfsucursal: {
                required: "Ingrese N&deg; de Tel&eacute;fono",
                digits: "Ingrese solo digitos para Tel&eacute;fono"
            },
            correosucursal: {
...
$('document').ready(function() {
    ...
    $("#savedocumentos").validate({
        ...
        messages: {
            tipo_de_documento: {
                required: "Ingrese Nombre de Documento"
            },
        },
        submitHandler: function(form) {
...
$('document').ready(function() {
    ...
    $("#savepaises").validate({
        ...
        messages: {
            npais: {
                required: "Ingrese NoIngrese Nombre de Pais"
            },
            activo: {
...
$('document').ready(function() {
    ...
    $("#saveprovincias").validate({
        ...
        messages: {
            nprovincia: {
                required: "Ingrese Nombre de Provincia"
            },
            id_pais: {
...
$('document').ready(function() {
    ...
    $("#savedepartamentos").validate({
        ...
        messages: {
            ndepartamento: {
                required: "Ingrese Nombre de Departamento"
            },
            id_pais: {
                required: "Seleccione Pais"
            },
...
$('document').ready(function() {
    ...
    $("#savebarrios").validate({
        ...
        messages: {
            nbarrio: {
                required: "Ingrese Nombre de Barrio"
            },
            id_pais: {
                required: "Seleccione Pais"
            },
...
$('document').ready(function() {
    ...
    $("#saveproducto").validate({
        ...
        messages: {
            descripcion: {
                required: "Ingrese Descripción de Producto"
            },
        },
        submitHandler: function(form) {
...
$('document').ready(function() {
    ...
    $("#saveperiodo").validate({
        rules: {
            ...
            vencimiento_de_reinscripcion: {
                required: true,
            },
            fecha_de_inicio_de_reinscripcion: {
                required: true,
            },
            primer_vencimiento_de_reinscripcion: {
                required: true,
            },
            aval_legal: {
                required: true,
        ...
        messages: {
            ...
            vencimiento_de_reinscripcion: {
                required: "Ingrese Vence Reinscripcion"
            },
            fecha_de_inicio_de_reinscripcion: {
                required: "Ingrese Inicio Reinscripcion"
            },
            primer_vencimiento_de_reinscripcion: {
                required: "Ingrese Primer Vence Reinscripcion"
            },
            aval_legal: {
                required: "Ingrese Aval Legal"
            },
        },
        submitHandler: function(form) {
...
$('document').ready(function() {
    ...
    $("#savesistemas").validate({
        ...
        messages: {
            descripcion: {
                required: "Ingrese Nombre de Sistema de Calidad"
            },
            activo: {
                required: "Seleccione Status"
            },
...
$('document').ready(function() {
    ...
    $("#savepromociones").validate({
        ...
        messages: {
            descripcion: {
                required: "Ingrese Nombre de Promocion"
            },
            activo: {
                required: "Seleccione Status"
            },
...
$('document').ready(function() {
    ...
    $("#saveinicio").validate({
        ...
        messages: {
            ...
            nombre: {
                required: "Ingrese Apellido y Nombre",
                lettersonly: "Ingrese solo letras para Apellidos y Nombres"
            },
            id_tipo_de_afectacion: {
                required: "Seleccione Tipo de Afectaci&oacute;n"
            },
            id_tipo_de_documento: {
            ...
            documento: {
                required: "Ingrese N&deg; de Documento",
                maxlength: "Ingrese 8 d&iacute;gitos como m&aacute;ximo"
            },
            numero: {
                required: "Ingrese Numero"
            },
            piso: {
                required: "Ingrese N&deg; de Piso"
            },
            depto: {
                required: "Ingrese N&deg; de Departamento"
            },
            referencias: {
                required: "Ingrese referencias Domicilio"
            },
            email_fiscal: {
                required: "Ingrese Email de Usuario",
                email: "Ingrese un Email V&aacute;lido",
...
$('document').ready(function() {
    ...
    $('#saveContribuyente').validate({
        rules: {
            ...
            buscar_provincia_administracion: {
                required: true,
            },
            buscar_localidad2: {
                required: true,
            ...
            depto_administracion: {
                required: false,
            },
            ref_domicilio_administracion: {
                required: false,
            },
        ...
        messages: {
            ...
            fecha_actividad_contribuyente: {
                required: "Ingrese Fecha de Inicio Actividad de Contribuyente"
            },
            id_regimen_ib: {
                required: "Seleccione Régimen de Ingresos Brutos"
            },
            numero_de_ib: {
                required: "Ingrese Nº de Ingresos Brutos"
            },
            id_condicion_iva: {
                required: "Seleccione Condición de Iva"
            },
            id_naturaleza_juridica: {
                required: "Seleccione Naturaleza Juridica"
            },
            //email_fiscal: { required: "Ingrese Email Fiscal", email: "Ingrese un Email V&aacute;lido" },
            zona_administracion: {
                required: "Seleccione Zona Administrativa"
            },
            buscar_provincia_administracion: {
                required: "Ingrese Nombre de Provincia Administrativa"
            },
            buscar_localidad2: {
                required: "Ingrese Nombre de Localidad Administrativa"
            },
            buscar_barrio2: {
                required: "Ingrese Nombre de Barrio Administrativa"
            },
            buscar_calle2: {
                required: "Ingrese Nombre de Calle Administrativa"
            },
            numero_administracion: {
                required: "Ingrese Numero"
            },
...
$('document').ready(function() {
    ...
    $('#savegeneral').validate({
        rules: {
            ...
            tel_fijo_administracion: {
                required: false,
            },
            tel_celular_administracion: {
                required: false,
            },
            direccion_gps: {
                required: true,
        ...
        messages: {
            id_periodo_fiscal: {
                required: "Seleccione Periodo Fiscal"
            },
            razon_social: {
                required: "Ingrese Nombre o Razon Social de la Empresa",
                lettersonly: "Ingrese solo letras para Nombres"
            },
            fecha_actividad_contribuyente: {
                required: "Ingrese Fecha de Inicio Actividad de Contribuyente"
            ...
            fecha_actividad_industria: {
                required: "Ingrese Fecha de Inicio Actividad de Industria"
            },
            es_casa_central: {
                required: "Seleccione si Es Casa Central",
            },
            tel_fijo: {
                required: "Ingrese Nº de Teléfono Fijo"
            },
            tel_celular: {
                required: "Ingrese Nº de Celular de Contacto de Empresa"
            },
            cod_postal: {
                required: "Ingrese Codigo Postal"
            },
            email_fiscal: {
                required: "Ingrese Email Fiscal",
                email: "Ingrese un Email V&aacute;lido"
            },
            zona: {
                required: "Seleccione Zona de Planta"
            },
            buscar_localidad: {
                required: "Ingrese Nombre de Localidad de Planta"
            },
            buscar_barrio: {
                required: "Ingrese Nombre de Barrio de Planta"
            },
            buscar_calle: {
                required: "Ingrese Nombre de Calle de Planta"
            },
            numero_planta: {
                required: "Ingrese Numero"
            },
            ...
            tel_celular_administracion: {
                required: "Ingrese Nº de Celular de Contacto en Administración"
            },
            direccion_gps: {
                required: "Ingrese Dirección GPS"
            },
            latitud: {
                required: "Ingrese Coordenadas de Latitud"
            },
            longitud: {
                required: "Ingrese Coordenadas de Longitud"
            },
            pagina_web: {
                required: "Ingrese Url de Pagina",
                url: "Ingrese un Dirección de Url V&aacute;lida"
            },
            email: {
                required: "Ingrese Email de Empresa",
                email: "Ingrese un Email V&aacute;lido"
            },
        },
        submitHandler: function(form) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.id_industria != "error") {
                        $("#id_industria_modal").val(data.id_industria); //se establece el id de la industria a utilizar en todos los modales
                        lanzador(); //para que muestre el periodo a cargar
                    }
                    if (data.status == 1) {
                        $("#save").fadeIn(1000, function() {
                            var n = noty({
    ...
    $("#btn-update-generales").on('click', function() {
        if ($("#updategeneral").valid()) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.status == 1) {
                        $("#save").fadeIn(1000, function() {
                            var n = noty({
                                text: "<span class='fa fa-warning'></span>",
                                theme: 'defaultTheme',
                                layout: 'center',
                                type: 'warning',
                                timeout: 5000,
...
$("#btn-actividad").on('click', function() {
    ...
    $("#saveactividad").validate({
        ...
        messages: {
            search_codigo: {
                required: "Realice la Búsqueda de Actividad por Código"
            },
            search_descripcion: {
                required: "Realice la Búsqueda de Actividad por Descripción"
            },
            observacion: {
                required: "Ingrese Descripción de la Actividad"
            },
            fecha_inicio: {
                required: "Ingrese Fecha de Inicio"
            },
            es_actividad_principal: {
                required: "Seleccione Si es Actividad Principal"
            },
...
function muestraForm(ref) {
    ...
    if ($("#id_industria_modal").val() < 1) {
        ...
        if (ref == "actividades") {
            //$("#labelActividad").hide();
            $("#info_actividad").hide();
            $("#div_info_actividad").show();
        }
        if (ref == "insumos") {
            $("#info_insumos").hide();
            $("#div_info_insumos").show();
        }
        if (ref == "splanta") {
            $("#info_sp").hide();
            $("#div_info_sp").show();
        ...
        if (ref == "generales") {} else if (ref == "actividades") {
            $("#info_actividad").show();
            $("#div_info_actividad").hide();
            cargar_tabla_actividades();
        } else if (ref == "insumos") {
            $("#info_insumos").show();
            $("#div_info_insumos").hide();
            getunidades();
            getMotivo();
            getServicios("sb", 1);
            getServicios("com", 2);
...
$('document').ready(function() {
    ...
    $("#saveasignacionproducto").validate({
        rules: {
            ...
            ventas_en_otras_provincias: {
                required: true,
                number: true
            },
            ventas_internacionales: {
                required: true,
                number: true
            },
        },
        messages: {
            search_producto: {
                required: "Realice la Búsqueda del Producto o Ingrese Descripción"
            },
            medida_producto: {
                required: "Seleccione Unidad Medida"
            },
            cantidad_producida: {
                required: "Ingrese Cantidad de Producto",
            ...
            ventas_en_provincia: {
                required: "Ingrese Cant. en Ventas en Provincia",
                number: "Ingrese solo digitos"
            },
            ventas_en_otras_provincias: {
                required: "Ingrese Cant. en Ventas en Otras Provincias",
                number: "Ingrese solo digitos"
            },
            ventas_internacionales: {
                required: "Ingrese Cant. en Ventas en el Exterior",
                number: "Ingrese solo digitos"
            },
        },
        submitHandler: function(form) {
...
$('document').ready(function() {
    ...
    $("#saveasignacionmateria").validate({
        rules: {
            ...
            search_provincia_materia: {
                required: true,
            },
            search_localidad_materia: {
                required: true,
            },
            motivo_importacion_materia: {
                required: true,
            },
            detalles_materia: {
                required: true,
        ...
        messages: {
            search_materia: {
                required: "Realice la Búsqueda de Materia Prima o Ingrese Descripción"
            },
            medida_materia: {
                required: "Seleccione Unidad Medida"
            },
            cantidad_materia: {
                required: "Ingrese Cantidad de Materia",
                number: "Ingrese solo digitos"
            },
            es_propio_materia: {
                required: "Seleccione si es Propia o Adquirida"
            },
            search_pais_materia: {
            ...
            motivo_importacion_materia: {
                required: "Ingrese Motivo de Importación"
            },
            detalles_materia: {
                required: "Ingrese Detalles de Importación"
            },
        },
        submitHandler: function(form) {
...
$('document').ready(function() {
    ...
    $("#saveasignacioninsumo").validate({
        rules: {
            ...
            search_provincia_insumo: {
                required: true,
            },
            search_localidad_insumo: {
                required: true,
            },
            motivo_importacion_insumo: {
                required: true,
            },
            detalles_insumo: {
                required: true,
        ...
        messages: {
            search_insumo: {
                required: "Realice la Búsqueda de Insumo o Ingrese Descripción"
            },
            medida_insumo: {
                required: "Seleccione Unidad Medida"
            },
            cantidad_insumo: {
                required: "Ingrese Cantidad de Insumo",
                number: "Ingrese solo digitos"
            },
            es_propio_insumo: {
                required: "Seleccione si es Propia o Adquirida"
...
$('document').ready(function() {
    ...
    $("#saveserviciobasico").validate({
        ...
        messages: {
            costo_basico: {
                required: "Ingrese Costo Asociado",
                number: "Ingrese solo digitos"
            },
        },
        submitHandler: function(form) {
...
$('document').ready(function() {
    ...
    $("#updateserviciobasico").validate({
        ...
        messages: {
            cantidad_servicio: {
                required: "Ingrese Cantidad Consumida"
            },
            costo_servicio: {
                required: "Ingrese Costo Asociado",
                number: "Ingrese solo digitos"
...
$('document').ready(function() {
    ...
    $("#savecombustible").validate({
        rules: {
            ...
            search_pais_combustible: {
                required: true,
            },
            search_provincia_combustible: {
                required: true,
            },
            search_localidad_combustible: {
                required: true,
            },
            motivo_importacion_combustible: {
                required: true,
            },
            detalles_combustible: {
                required: true,
            },
        },
        messages: {
            id_servicio_combustible: {
                required: "Seleccione Tipo de Combustible"
            },
            medida_combustible: {
                required: "Seleccione Unidad de Medida"
            },
            frecuencia_combustible: {
                required: "Ingrese Frecuencia de Contratación"
            },
            cantidad_combustible: {
                required: "Ingrese Veces de Contratación",
                number: "Ingrese solo digitos"
            },
            costo_combustible: {
                required: "Ingrese Costo de Combustible",
                number: "Ingrese solo digitos"
            },
            search_pais_combustible: {
                required: "Ingrese Nombre de Pais"
...
$('document').ready(function() {
    ...
    $("#saveotros").validate({
        rules: {
            ...
            search_provincia_otros: {
                required: true,
            },
            search_localidad_otros: {
                required: true,
            },
            motivo_importacion_otros: {
                required: true,
            },
            detalles_otros: {
                required: true,
        ...
        messages: {
            search_servicio: {
                required: "Ingrese Nombre o Descripción de Servicio"
            },
            servicio_contratado: {
                required: "Seleccione Servicio Contratado"
            },
            frecuencia_otros: {
                required: "Ingrese Frecuencia de Contratación"
            },
            ...
            search_pais_servicio: {
                required: "Ingrese Nombre de Pais"
            },
            search_provincia_servicio: {
                required: "Ingrese Nombre de Provincia"
            },
            search_localidad_servicio: {
                required: "Ingrese Nombre de Localidad"
            },
            motivo_importacion_otros: {
                required: "Ingrese Motivo de Importación"
...
$('document').ready(function() {
    ...
    $("#savesituacion").validate({
        ...
        messages: {
            produccion_sobre_capacidad: {
                required: "Ingrese Porcentaje de Producción",
                number: "Ingrese solo digitos"
            },
            superficie_lote: {
                required: "Ingrese Superficie de Lote Industrial"
            },
            superficie_planta: {
                required: "Ingrese Superficie de Lote Planta"
            },
            es_zona_industrial: {
                required: "Seleccione si es Zona Industrial"
            },
            declara_inversion: {
                required: "Seleccione Declara Inversión"
            },
            inversion_anual: {
                required: "Ingrese Importe de Inversión",
                number: "Ingrese solo digitos"
            },
            inversion_activo_fijo: {
                required: "Ingrese Inversión Activo Fijo",
                number: "Ingrese solo digitos"
            },
            capacidad_instalada: {
                required: "Ingrese Porcentaje de Capacidad Instalada",
                number: "Ingrese solo digitos"
            },
            capacidad_ociosa: {
                required: "Ingrese Porcentaje de Capacidad Ociosa",
                number: "Ingrese solo digitos"
            },
        },
        submitHandler: function(form) {
...
$('document').ready(function() {
    ...
    $("#savemotivoasignado").validate({
        ...
        messages: {
            search_motivo: {
                required: "Realice la Búsqueda de Motivo Ociosidad o Ingrese Descripción"
            },
        },
        submitHandler: function(form) {
...
$('document').ready(function() {
    ...
    $("#savepersonal").validate({
        ...
        messages: {
            rol_trabajador: {
                required: "Seleccione Rol de Trabajador"
            },
        },
        submitHandler: function(form) {
...
$('document').ready(function() {
    ...
    $("#saveventa").validate({
        ...
        messages: {
            clasif_venta: {
                required: "Seleccione Clasificación"
            },
            ventas_provincias: {
...
$('document').ready(function() {
    ...
    $("#savefacturacion").validate({
        rules: {
            ...
            prevision_ingresos_anio_corriente_dolares: {
                required: true,
                number: true
            },
            porcentaje_prevision_mercado_interno: {
                required: true,
                number: true
            },
            porcentaje_prevision_mercado_externo: {
                required: true,
                number: true
            },
        },
        messages: {
            ...
            prevision_ingresos_anio_corriente: {
                required: "Ingrese Facturación Anual en Año Corriente (Pesos)",
                number: "Ingrese solo digitos"
            },
            prevision_ingresos_anio_corriente_dolares: {
                required: "Ingrese Facturación Anual en Año Corriente (USD)",
                number: "Ingrese solo digitos"
            },
            porcentaje_prevision_mercado_interno: {
                required: "Ingrese Facturación Mercado Interno (%)",
                number: "Ingrese solo digitos"
            },
            porcentaje_prevision_mercado_externo: {
                required: "Ingrese Facturación Mercado Externo (%)",
                number: "Ingrese solo digitos"
            },
        },
        submitHandler: function(form) {
...
$('document').ready(function() {
    ...
    $("#saveefluente").validate({
        ...
        messages: {
            search_efluente_e: {
                required: "Ingrese Nombre o Descripción de Residuo"
            },
            tratamiento_residuo: {
                required: "Ingrese Tratamiento Residuo"
            },
            destino: {
                required: "Ingrese Destino Final "
            },
        },
        submitHandler: function(form) {
...
$('document').ready(function() {
    ...
    $("#saveeconomia").validate({
        ...
        messages: {
            otro_sector: {
                required: "Ingrese Otros Sectores"
            },
            otro_personal: {
                required: "Ingrese Otros Personal"
            },
        },
        submitHandler: function(form) {
