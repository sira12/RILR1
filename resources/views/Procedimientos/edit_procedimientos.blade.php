                    ...
                    <div class="card-body">
                        ...
                        <div class="form-body">
                            ...
                            <div class="row-horizon">
                                ...
                                <span class="categories" href="#act"><i class="fa fa-tasks"></i> Actividad</span>
                                <span class="categories" id="seccion#3"><i class="fa fa-tasks"></i> Insumos y Servicios</span>
                            ...
                            <div id="secciones" class="mt-3">
                                ...
                                <section id="datosGenerales">
                                    <form class="form-material" method="post" action="#" name="updategeneral" id="updategeneral" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group has-feedback">
                                                    ...
                                                    <input type="text" class="form-control" name="nombre_de_fantasia" id="nombre_de_fantasia" placeholder="Ingrese Nombre de Establecimiento Industrial" autocomplete="off" value="{{$mi_industria[0]->nombre_de_fantasia}}" required="" aria-required="true" />
                                                    <i class="fa fa-pencil form-control-feedback"></i>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group has-feedback">
                                                    ...
                                                    <input type="text" class="form-control actividades" name="fecha_actividad_industria" id="fecha_actividad_industria" placeholder="Ingrese Fecha Inicio Actividad de Industria" autocomplete="off" value="{{\Carbon\Carbon::parse($mi_industria[0]->fecha_inicio)->format('d-m-Y')}}" required="" aria-required="true" />
                                                    <i class="fa fa-calendar form-control-feedback"></i>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group has-feedback">
                                                    ...
                                                    <input type="text" class="form-control" name="tel_fijo" id="tel_fijo" placeholder="Ingrese Nº de Teléfono Fijo" value="{{$mi_industria[0]->tel_fijo}}" autocomplete="off" required="" aria-required="true" />
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-feedback">
                                                    ...
                                                    <input type="text" class="form-control" name="tel_celular" id="tel_celular" placeholder="Ingrese Nº de Celular" autocomplete="off" value="{{$mi_industria[0]->tel_celular}}" required="" aria-required="true" />
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group has-feedback">
                                                    ...
                                                    <input type="text" class="form-control" name="cod_postal" id="cod_postal" placeholder="Ingrese Código Postal" autocomplete="off" value="{{$mi_industria[0]->cod_postal}}" required="" aria-required="true" />
                                                    <i class="fa fa-pencil form-control-feedback"></i>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-feedback">
                                                    <label class="control-label">Correo Electrónico fiscal:<span style="cursor: pointer;" class="mdi mdi-alert-circle text-danger" data-container="body" title="Notificación: Esta será la dirección electrónica constituida a fines de remitir notificaciones y comunicados oficiales  "></span>
                                                        <span class="symbol required"></span></label>
                                                    <input type="text" class="form-control" name="email_fiscal" id="email_fiscal" placeholder="Ingrese Correo Electrónico para Trámite" autocomplete="off" value="{{$mi_industria[0]->email_fiscal}}" required="" aria-required="true" disabled />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group has-feedback">
                                                    ...
                                                    <input type="hidden" name="id_provincia" id="id_provincia" value="{{$mi_industria[0]->id_provincia_planta}}" />
                                                    <input type="text" class="form-control" name="buscar_provincia" id="buscar_provincia" placeholder="Ingrese Nombre de Provincia" value="{{$mi_industria[0]->provincia_planta}}" required="" aria-required="true" />
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group has-feedback">
                                                    ...
                                                    <input type="hidden" name="id_localidad" id="id_localidad" value="{{$mi_industria[0]->id_localidad_planta}}" />
                                                    <input type="text" class="form-control" disabled name="buscar_localidad" id="buscar_localidad" placeholder="Ingrese Nombre de Localidad" value="{{$mi_industria[0]->localidad_planta}}" required="" aria-required="true" />
                                                    <i class="fa fa-search form-control-feedback"></i>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group has-feedback">
                                                    ...
                                                    <input type="text" class="form-control" disabled name="buscar_barrio" id="buscar_barrio" placeholder="Ingrese Nombre de Barrio" autocomplete="off" value="{{$mi_industria[0]->barrio_planta}}" required="" aria-required="true" />
                                                    <i class="fa fa-search form-control-feedback"></i>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group has-feedback">
                                                    ...
                                                    <input type="text" class="form-control" disabled name="buscar_calle" id="buscar_calle" placeholder="Ingrese Nombre de Calle" autocomplete="off" value="{{$mi_industria[0]->calle_planta}}" required="" aria-required="true" />
                                                    <i class="fa fa-search form-control-feedback"></i>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group has-feedback">
                                                    ...
                                                    <input type="number" class="form-control" name="nro_calle_panta" id="nro_calle_panta" placeholder="Ingrese Numero de Calle" autocomplete="off" aria-required="true" value="{{$mi_industria[0]->nro_calle_planta}}" />
                                                    <i class="fa fa-pencil form-control-feedback"></i>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group has-feedback">
                                                    ...
                                                    <input type="number" class="form-control" name="nro_piso_planta" id="nro_piso_planta" placeholder="Ingrese Numero de Piso" autocomplete="off" aria-required="true" value="{{$mi_industria[0]->piso_planta}}" />
                                                    <i class="fa fa-pencil form-control-feedback"></i>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group has-feedback">
                                                    ...
                                                    <input type="number" class="form-control" name="nro_departamento_planta" id="nro_departamento_planta" placeholder="Ingrese Numero de Departamento" autocomplete="off" aria-required="true" value="{{$mi_industria[0]->depto_planta}}" />
                                                    <i class="fa fa-pencil form-control-feedback"></i>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group has-feedback">
                                                    ...
                                                    <input type="text" class="form-control" name="referencia_planta" id="referencia_planta" placeholder="Ingrese una referencia" autocomplete="off" aria-required="true" value="{{$mi_industria[0]->referencia_planta}}" />
                                                    <i class="fa fa-pencil form-control-feedback"></i>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="form-group has-feedback">
                                                    ...
                                                    <input type="text" class="form-control" name="latitud" id="latitud" placeholder="Ingrese Latitud de Ubicación" autocomplete="off" value="{{$mi_industria[0]->latitud}}" required="" aria-required="true" />
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group has-feedback">
                                                    ...
                                                    <input type="text" class="form-control" name="longitud" id="longitud" placeholder="Ingrese Longitud de Ubicación" autocomplete="off" value="{{$mi_industria[0]->longitud}}" required="" aria-required="true" />
                                                    <i class="fa fa-map-marker form-control-feedback"></i>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group has-feedback">
                                                    <label class="control-label">Pagina Web (Ej: http://dominio.com):
                                                        <span class="symbol required"></span></label>
                                                    <input type="url" class="form-control" name="pagina_web" id="pagina_web" placeholder="Ingrese Url de Pagina Web" autocomplete="off" value="{{$mi_industria[0]->pagina_web}}" required="" aria-required="true" />
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group has-feedback">
                                                    ...
                                                    <input type="text" class="form-control" name="email" id="email" placeholder="Ingrese Correo Electrónico de Empresa" autocomplete="off" value="{{$mi_industria[0]->email}}" required="" aria-required="true" />
                                                    <i class="fa fa-envelope-o form-control-feedback"></i>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="text-right">
                                            <button type="submit" name="btn-submit-edit" id="btn-submit-edit" class="btn btn-danger"><span class="fa fa-save"></span> Guardar
                                            </button>
                                        </div>
                                            ...
                                            <table id="default_order" class="table table-deredbor border display">
                                                ...
                                                <tbody class="BusquedaRapida">
                                                    ...
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td></td>
                                                        <td>
                                                            <span style="cursor: pointer;" data-placement="left" title="Ver Actividad" data-original-title="" data-href="#" data-toggle="modal" data-target="#MyModalDetalleActividad" data-backdrop="static" data-keyboard="false" onClick=""><i class="mdi mdi-eye font-22 text-danger"></i></span>

                                                            <span style="cursor: pointer;" data-placement="left" title="Asignar o Editar Producto Cargado" data-original-title="" data-href="#" data-toggle="modal" data-target="#MyModalAsignaProducto" onClick=""><i class="mdi mdi-plus-outline font-22 text-danger"></i></span>

                                                            <span style="cursor: pointer;" data-placement="left" title="Actualizar Actividad" data-original-title="" data-href="#" data-toggle="modal" data-target="#MyModalActividad" data-backdrop="static" data-keyboard="false"><i class="mdi mdi-table-edit font-22 text-danger"></i></span>

                                                            <span style="cursor: pointer;" title="Eliminar Actividad"><i class="mdi mdi-delete font-22 text-danger"></i></span>
                                                        </td>
                                                    </tr>
