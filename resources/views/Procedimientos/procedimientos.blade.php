                        ...
                        <div class="form-body">
                            ...
                            <div id="secciones" class="mt-3">
                                ...
                                <section id="ddjj">
                                    ...
                                    <div class='alert alert-danger' id="div_info_dj" style="display: none;">
                                        <center><span class='fa fa-info-circle'></span>Por favor debe realizar la carga de todos los datos de las secciones antes de generar la Declaracion Jurada.</center>
                                    </div>
